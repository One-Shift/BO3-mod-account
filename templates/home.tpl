...
<div id="info" class="row">
    <div class="hidden-xs col-sm-3 col-md-3 col-lg-3 tacenter">
...
<div class="mb-spacer30 spacer30"></div>
...
<div class="row">
    ...
    <a href="{c2r-path-bo}/0/{c2r-lg}/home/" role="button" class="btn btn-cancel pull-right"><i class="fa fa-times" aria-hidden="true"></i><div class="block15"></div> {c2r-lg-cancel}</a>
    <button type="submit" class="btn btn-save pull-right" name="submit"><i class="fa fa-floppy-o" aria-hidden="true"></i><div class="block15"></div> {c2r-lg-save}</button>
</form>
